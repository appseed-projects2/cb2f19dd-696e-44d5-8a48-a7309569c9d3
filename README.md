...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-10 12:27`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cb2f19dd-696e-44d5-8a48-a7309569c9d3.git
$ cd cb2f19dd-696e-44d5-8a48-a7309569c9d3
```
